...
def main():
    ...
    # _, obj_anns, _ = prepare_for_coco_detection_KITTI(outputs["instances"].to("cpu"), cfg.OUTPUT_DIR, BEV_im_path, False, calib_path, True, 12, True, True, True)
